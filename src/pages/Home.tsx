        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {CATEGORIES.map((category) => (
            <Link
              ...
              className="group bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-slate-200 hover:border-amber-400 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-amber-50 border border-amber-200 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 group-hover:bg-amber-500 group-hover:text-slate-950 transition-colors">
                  <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-amber-600 group-hover:text-slate-950" />
                </div>
                <h3 className="text-sm sm:text-lg font-bold text-slate-900 group-hover:text-amber-700 transition-colors">
                  {category.name}
                </h3>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] sm:text-xs font-bold text-amber-700">
